  ...
  return (
    <div>
      ...
      {displayedJobs.map((job,index) => (
        <JobCardComponent key={index} id={job.jobId} title={job.jobTitle} company={job.company} location={job.location} description={job.description} link={job.url} showLargeDrawer={showLargeDrawer} />
      ))}
